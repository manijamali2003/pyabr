...
class MainApp(QMainWindow):
    ...
    def __init__(self,ports, *args, **kwargs):
        ...
        self.Widget.SetWindowTitle("Untitled - Lightword")
        ...
        save_file_action = QAction(QIcon(img), "Save", self)
        save_file_action.setStatusTip("Save current page")
        save_file_action.triggered.connect(self.file_save)
        file_menu.addAction(save_file_action)
        file_toolbar.addAction(save_file_action)
        img = res.get('@icon/document-save-as')
        saveas_file_action = QAction(QIcon(img), "Save As...", self)
        ...
        undo_action = QAction(QIcon(img), "Undo", self)
        undo_action.setStatusTip("Undo last change")
        undo_action.triggered.connect(self.editor.undo)
        edit_menu.addAction(undo_action)
        img = res.get('@icon/arrow-curve')
        redo_action = QAction(QIcon(img), "Redo", self)
        ...
        cut_action = QAction(QIcon(img), "Cut", self)
        ...
        copy_action = QAction(QIcon(img), "Copy", self)
        ...
        paste_action = QAction(QIcon(img), "Paste", self)
        ...
        select_action = QAction(QIcon(img), "Select all", self)
        ...
        wrap_action = QAction(QIcon(img), "Wrap text to window", self)
        ...
        self.bold_action = QAction(QIcon(img), "Bold", self)
        ...
        self.italic_action = QAction(QIcon(img), "Italic", self)
        ...
        self.underline_action = QAction(QIcon(img), "Underline", self)
        ...
        self.alignl_action = QAction(QIcon(img), "Align left", self)
        ...
        self.alignc_action = QAction(QIcon(img), "Align center", self)
        ...
        self.alignr_action = QAction(QIcon(img), "Align right", self)
        ...
        self.alignj_action = QAction(QIcon(img), "Justify", self)
    ...
    def file_open(self):
        self.Env.RunApp('select', ['Open document', 'open', self.file_open_])
    ...
    def file_save(self):
        if not self.Widget.WindowTitle() == 'Untitled - Lightword':
            files.write(files.output(self.Widget.WindowTitle()), self.editor.toHtml())
        else:
            self.Env.RunApp('select', ['Save document', 'save', self.file_saveas_])
    ...
    def file_saveas(self):
        self.Env.RunApp('select', ['Save as document', 'save-as', self.file_saveas_])
